...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD      216   // 217.3 mm
  ...
  #define DELTA_HEIGHT 325 // get this value from auto calibrate
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define DELTA_PROBEABLE_RADIUS (DELTA_PRINTABLE_RADIUS - MIN_PROBE_EDGE)
